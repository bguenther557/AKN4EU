...
| Long title (docType / docNumber / docDate) | REGULATION / (EU) 2024/2690 / 2024-10-18 |
...
```json
{
  ...
  "metadata": {
    ...
    "relation_counts": {
      ...
      "recital_to_annex": 53,
      "recital_to_article": 45,
      "recital_to_recital": 40,
  ...
  "recital_to_recital": [
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 1,
      "reasoning": "R1 establishes the Regulation's scope and purpose. R3 discusses the standards basis (ISO, ETSI) for the technical requirements, which presupposes the scope of entities and requirements established in R1.",
      "relation": "provides_context_for",
      "to_recital": 3,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "low",
      "from_recital": 1,
      "reasoning": "R1 establishes the entity types in scope. R7 discusses ENISA and national authorities providing guidance for risk assessment to those same entities. R1's scope definition provides context for who R7's guidance targets.",
      "relation": "provides_context_for",
      "to_recital": 7,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "low",
      "from_recital": 1,
      "reasoning": "R1 establishes the entity types in scope. R11 discusses the risk management framework those entities should establish. R1's scope definition provides context for which entities R11's framework requirements address.",
      "relation": "provides_context_for",
      "to_recital": 11,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 3,
      "reasoning": "R3 establishes the international standards basis (ISO, ETSI) for the technical requirements. R8 describes specific network security measures (protocols, email authentication, DNS routing) that should align with those internationally agreed standards.",
      "relation": "provides_context_for",
      "to_recital": 8,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 4,
      "reasoning": "R4 discusses proportionality based on inability to implement due to risk exposure and size. R6 qualifies this by adding another dimension of conditional application — requirements should be applied 'where appropriate, where applicable, or to the extent feasible' — adding nuance beyond R4's inability-based proportionality.",
      "relation": "qualifies",
      "to_recital": 6,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 5,
      "reasoning": "R5 introduces compensating measures when requirements cannot be implemented. R6 qualifies this approach by adding the 'where appropriate, where applicable, to the extent feasible' conditional language, which applies more broadly than just compensating-measures scenarios.",
      "relation": "qualifies",
      "to_recital": 6,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 7,
      "reasoning": "R7 discusses ENISA and national authorities providing guidance for risk identification, analysis, and assessment. R8 then lists specific network security measures that such guidance could encompass, making R7 the contextual frame for R8's concrete measures.",
      "relation": "provides_context_for",
      "to_recital": 8,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 7,
      "reasoning": "R7 discusses ENISA/national authority guidance for risk assessment to support implementation. R11 establishes the risk management framework that such guidance would help entities build. R7's guidance context frames R11's framework requirements.",
      "relation": "provides_context_for",
      "to_recital": 11,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 11,
      "reasoning": "R11 establishes the risk management framework including risk treatment plans. R13 builds on this by specifying the business impact analysis methodology (MTD, RTO, RPO) that forms part of the risk assessment and treatment within that framework.",
      "relation": "builds_on",
      "to_recital": 13,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 12,
      "reasoning": "R12 discusses detecting and evaluating events, near misses, and incidents. R13 builds on this by introducing business impact analysis methodology to assess the consequences of detected events, creating a logical progression from detection to impact assessment.",
      "relation": "builds_on",
      "to_recital": 13,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 22,
      "reasoning": "R22 (employee security management to prevent misuse of access rights) qualifies R21 (access control) by adding the insider-threat dimension — it notes that access controls must also address the risk of authorized employees misusing their legitimate access, a qualification of the general access control requirement.",
      "relation": "qualifies",
      "to_recital": 21,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 15,
      "reasoning": "R15 (security testing to verify measures are implemented and function properly) provides context for R16 (patch management) — security testing identifies vulnerabilities and verifies measures, establishing the context for why patch management is necessary to address discovered vulnerabilities.",
      "relation": "provides_context_for",
      "to_recital": 16,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 27,
      "reasoning": "R27 (allocation of cybersecurity roles, responsibilities, and authorities) provides the organizational governance context for R22 (employee security management) — the roles framework establishes who is responsible for employee security measures, providing the structural context within which employee security management operates.",
      "relation": "provides_context_for",
      "to_recital": 22,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 21,
      "reasoning": "R21 (access control policy addressing access by persons and network elements) builds on R27 (roles, responsibilities, and segregation of duties) — access control policies assign access rights based on defined roles and responsibilities, making the roles framework a conceptual prerequisite for access control implementation.",
      "relation": "builds_on",
      "to_recital": 27,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 42,
      "reasoning": "R42 (EDPS consultation) builds on R41 (Cooperation Group and ENISA consultation) as the next sequential procedural step in the drafting and consultation process.",
      "relation": "builds_on",
      "to_recital": 41,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
    ...
    },
    {
      "confidence": "medium",
      "from_recital": 43,
      "reasoning": "R43 (committee opinion per comitology procedure) builds on R42 (EDPS consultation) as the final procedural step confirming the regulation's adoption process.",
      "relation": "builds_on",
      "to_recital": 42,
      "akn4eu_source_refers_to": null,
      "akn4eu_target_refers_to": null,
  ...
  "recitals_and_articles": [
    ...
    },
    {
      ...
      "outbound_relations": [
        {
          "confidence": "medium",
          "reasoning": "R6 states that certain Annex requirements should be applied 'where appropriate, where applicable, or to the extent feasible.' This directly concretizes Art2P1's technical and methodological requirements by specifying the conditional application language for the Annex measures.",
    ...
    },
    {
      ...
      "outbound_relations": [
        ...
        {
          "confidence": "medium",
          "reasoning": "R36 defines which direct financial losses count. Art4(1)(c) requires recurring incidents to collectively meet Art3(1)(a), i.e. the financial-loss threshold, so R36 guides the aggregation test as well.",
          "relation": "provides_guidance_for",
          "target_article": 4,
          "target_paragraph": "1",
          "target_type": "article_paragraph",
